...
public abstract class UserEntity_ extends com.ogoma.blog.setup.BaseEntity_ {
	...
	public static final String BLOGS_CREATED = "blogsCreated";
	public static final String LIKED_BLOGS = "likedBlogs";
	...
	/**
	 * @see com.ogoma.blog.iam.entities.UserEntity#blogsCreated
	 **/
	public static volatile SetAttribute<UserEntity, BlogEntity> blogsCreated;
	...
	/**
	 * @see com.ogoma.blog.iam.entities.UserEntity#likedBlogs
	 **/
	public static volatile SetAttribute<UserEntity, BlogEntity> likedBlogs;
	...
	/**
	 * @see com.ogoma.blog.iam.entities.UserEntity#notifications
	 **/
	public static volatile SetAttribute<UserEntity, NotificationEntity> notifications;
